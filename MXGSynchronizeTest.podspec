#
#  Be sure to run `pod spec lint MXGSynchronizeTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Max Goedjen"
  # s.authors            = { "Max Goedjen" => "max.goedjen@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Max Goedjen"
